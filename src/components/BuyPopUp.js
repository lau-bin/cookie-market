        ...
        >
            {
                <div style={{width:"300px",height:"120px",margin:"auto",background:"#F8EDE7",display:"flex",flexDirection:"column",justifyContent:"space-between",borderRadius:"8px"}} >
                    ...
                    <button ref={refClose}  onClick={()=>setFeedBack("")} style={{cursor:"pointer",alignSelf:"end",padding:'0',background:'#0000',border:'0'}}>
                        <svg width="36" height="36" fill="#915731" className="bi bi-x" viewBox="0 0 16 16">
                    ...
                    <h4 style={{textAlign:"center"}}>{feedBack}</h4>
                    {
                        ...
                        <button onClick={ e => handleBuyClick(e) } className="btnBuy" style={{alignSelf:"center",marginBottom:"20px"}}>Buy For {price} Near</button> :
                        <button onClick={ e => setFeedBack("") } className="btnBuy" style={{alignSelf:"center",marginBottom:"20px"}}>Ok</button> 
                    }
                </div>
            }
        </div>
