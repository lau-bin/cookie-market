  ...
  return (
    <>
          ...
          market.map(
            ({
              ...
              <>
                <div
                  key={token_id}
                  className="containerFlex flexColumn p-2 pb-4 m-2"
                  style={{
                    borderRadius: "8px",
                    boxShadow: "0px 0px 12px #C8ADA766",
                    cursor: "pointer",
                  }}
                  onClick={() =>
                    setPopUp({
      ...
      <div className="containerGrid">
        {tab === 1 && state.tokensLoading.sales && (
          <img
            src={Avatar}
            className="cookieSpinner"
            style={{ margin: "100px auto", gridColumnStart: "3" }}
          />
        )}
      </div>
      ...
      {tab === 2 && (
        <>
          {!signedIn && (
            <h4 style={{ margin: "100px auto", textAlign: "center" }}>
              Connect your wallet
            </h4>
          )}

          {signedIn && !tokens.length && !state.tokensLoading.sales && (
            <h4 style={{ margin: "100px auto", textAlign: "center" }}>
            ...
            {signedIn &&
              tokens.map(
                ({
                  ...
                  <div key={token_id}>
                    <div
                      className="containerFlex flexColumn p-2 m-2"
                      style={{
                        borderRadius: "8px",
                        boxShadow: "0px 0px 12px #C8ADA766",
                      }}
                        ...
                        <>
                          ...
                          {Object.keys(sale_conditions).length > 0 && (
                            <>
                              {Object.entries(sale_conditions).map(
                                ([ft_token_id, price]) => (
                                  <div className="textCenter" key={ft_token_id}>
                                    <h4
                                      style={{
                                        background: "#D18436",
                                        color: "white",
                          ...
                          {accountId === owner_id && sale_conditions.near && (
                            <>
                              ...
                              <button
                                onClick={() => {
                                  setLoading("true");
                                  handleSaleRemove(account, token_id);
                                }}
                              >
                                Remove From Market
                              </button>
          ...
          <div className="containerGrid">
            {tab === 2 && signedIn && state.tokensLoading.sales && (
              <img
                src={Avatar}
                className="cookieSpinner"
                style={{ margin: "100px auto", gridColumnStart: "3" }}
